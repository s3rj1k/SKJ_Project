...
java DatabaseClient -gateway localhost:9003 -operation get-max
sleep 1
java DatabaseClient -gateway localhost:9003 -operation find-key 7 # !!! maybe one of 9000,9005,9006 nodes
java DatabaseClient -gateway localhost:9004 -operation find-key 1 # !!! maybe one of 9000,9005,9006 nodes
sleep 1
